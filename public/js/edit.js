...
function editCell(e) {
    ...
    text_box.addEventListener("keyup", function(e) {
        if(e.which == 13) {//recognize enter key
            ...
            parent.parentNode.querySelector(".first_name :nth-child(1)").innerHTML,
            parent.parentNode.querySelector(".last_name :nth-child(1)").innerHTML,
            parent.parentNode.querySelector(".email :nth-child(1)").innerHTML,
            parent.parentNode.querySelector(".password :nth-child(1)").innerHTML)
